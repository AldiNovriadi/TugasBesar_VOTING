...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="/voting" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block">Tubes Voting</span>
            </a>
        ...
        <nav class="header-nav ms-auto">
            ...
            @else
                <li class="nav-item dropdown">
                    <a class="nav-item nav-link" href="/login"> Login Akun </a>
                </li>
                @endif
            </ul>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            @if (Auth::User())
                <li class="nav-item">
                    <a class="nav-link " href="/voting/create">
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
                        <i class="bi bi-menu-button-wide"></i><span>Kelola Voting</span><i
                        ...
                        <li>
                            ...
                            @foreach ($voting as $votings)
                                <a href="/voting/{{ $votings->id }}/edit">
                                    <i class="bi bi-circle"></i><span>{{ $votings->question }}</span>
                                </a>
                            @endforeach
                        </li>
                    </ul>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-bar-chart"></i><span>Result Voting</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        ...
                        @endphp
                        @foreach ($voting as $votings)
                            <a href="/voting/result/{{ $votings->id }}">
                                <i class="bi bi-circle"></i><span>{{ $votings->question }}</span>
                            </a>
                        @endforeach
                    </li>
